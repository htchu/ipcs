  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-12">
      ...
      <p className="text-lg text-gray-500 mb-10">
        {language === "en" ? "" : "About IPCS"}
      </p>

      {/* History */}
      <section className="mb-12">
        <h2 className="text-2xl font-bold text-gray-800 mb-1">
          {t("學程歷史", "Program History")}
        </h2>
        <p className="text-base text-gray-500 mb-6">
          {language === "en" ? "" : "Program History"}
        </p>
        <div className="grid md:grid-cols-3 gap-6">
          <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm text-center">
            <div className="text-3xl font-bold text-primary mb-1">2020</div>
            <div className="text-sm text-gray-400 mb-3">
              {language === "en" ? "R.O.C. Year 109" : "民國 109 年"}
            </div>
            <h3 className="text-lg font-bold text-gray-800 mb-2">
              {language === "en" ? "Preparation Phase" : "籌備階段"}
            </h3>
            <p className="text-sm text-gray-500 mb-1">
              {language === "en" ? "" : "Preparation Phase"}
            </p>
            <p className="text-sm text-gray-600 mt-3">
              {language === "en"
                ? "Preparatory committee meetings established the curriculum framework, graduation requirements, class formation, and faculty principles."
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm text-center">
            ...
            <div className="text-sm text-gray-400 mb-3">
              {language === "en" ? "R.O.C. Year 110" : "民國 110 年"}
            </div>
            <h3 className="text-lg font-bold text-gray-800 mb-2">
              {language === "en" ? "Officially Established" : "正式成立"}
            </h3>
            <p className="text-sm text-gray-500 mb-1">
              {language === "en" ? "" : "Officially Established"}
            </p>
            <p className="text-sm text-gray-600 mt-3">
              {language === "en"
                ? "The program was officially established, offering a full 4-year bachelor's degree training."
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm text-center">
            ...
            <div className="text-sm text-gray-400 mb-3">
              {language === "en" ? "R.O.C. Year 114" : "民國 114 年"}
            </div>
            <h3 className="text-lg font-bold text-gray-800 mb-2">
              {language === "en" ? "First Graduating Class" : "首屆畢業生"}
            </h3>
            <p className="text-sm text-gray-500 mb-1">
              {language === "en" ? "" : "First Graduating Class"}
            </p>
            <p className="text-sm text-gray-600 mt-3">
              {language === "en"
                ? "Welcomed the first graduating class, demonstrating the results of full-English instruction and IT professional training."
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-bold text-gray-800 mb-1">
          {language === "en" ? "Positioning" : "自我定位"}
        </h2>
        <p className="text-base text-gray-500 mb-6">
          {language === "en"
            ? "EMI Program of the College of Computing and Informatics"
            : "Positioning: EMI Program of the College of Computing and Informatics"}
        </p>
        <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm mb-6">
          <p className="text-gray-700 mb-2">
            {language === "en"
              ? "IPCS is the only English as a Medium of Instruction (EMI) program in the College of Computing and Informatics, alongside the following departments:"
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
            ...
            <h3 className="font-bold text-gray-800 mb-1">
              {language === "en" ? "Full-English Learning Environment" : "全英語學習環境"}
            </h3>
            <p className="text-sm text-gray-500 mb-3">
              {language === "en" ? "" : "Full-English Learning Environment"}
            </p>
            <p className="text-sm text-gray-600">
              {language === "en"
                ? "All courses are taught 100% in English (EMI), training students to learn and communicate in computer science in English."
                : "課程 100% 以英語授課（English as Medium of Instruction），訓練學生以英語進行電腦科學學習與溝通"}
            </p>
            {language === "zh" && (
              <p className="text-sm text-gray-500 mt-1">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
            <div className="text-3xl mb-3">🤝</div>
            <h3 className="font-bold text-gray-800 mb-1">
              {language === "en" ? "Learning with International Students" : "國際學生共學"}
            </h3>
            <p className="text-sm text-gray-500 mb-3">
              {language === "en" ? "" : "Learning with International Students"}
            </p>
            <p className="text-sm text-gray-600">
              {language === "en"
                ? "Study alongside international students from around the world, building cross-cultural collaboration skills and real global connections."
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
            ...
            <h3 className="font-bold text-gray-800 mb-1">
              {language === "en" ? "Preparation for Study Abroad / Exchange" : "出國留學 / 交換準備"}
            </h3>
            <p className="text-sm text-gray-500 mb-3">
              {language === "en" ? "" : "Preparation for Study Abroad / Exchange"}
            </p>
            <p className="text-sm text-gray-600">
              {language === "en"
                ? "Adapt to a full-English academic environment in advance, building the language and cultural foundation for studying abroad or exchange programs."
      ...
      <section className="mb-12">
        ...
        <p className="text-base text-gray-500 mb-6">
          {language === "en" ? "" : "Role 2: A Bridge for Recruiting International Students"}
        </p>
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
            <h3 className="font-bold text-gray-800 mb-3">
              {language === "en" ? "Current Channels for International Students" : "目前外國學生管道"}
            </h3>
            <p className="text-sm text-gray-500 mb-4">
              {language === "en" ? "" : "Current Channels for International Students"}
            </p>
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
            <h3 className="font-bold text-gray-800 mb-3">
              {language === "en" ? "Future Vision through IPCS" : "透過 IPCS 串接的未來願景"}
            </h3>
            <p className="text-sm text-gray-500 mb-4">
              {language === "en" ? "" : "Future Vision through IPCS"}
            </p>
            <ul className="space-y-2 text-sm text-gray-600">
              <li className="flex items-start gap-2">
                <span className="text-primary font-bold mt-0.5">•</span>
